...
for kFile = 1:numel(nsrFiles)
    ...
    for k = 1:nSeg
       s = segments{k};
       [t12e, t23e, t12ee, t23ee] = thetas(s);
...
t12_emd_all_nsr_deg = rad2deg(t12_emd_all_nsr);
t23_emd_all_nsr_deg = rad2deg(t23_emd_all_nsr);
t12_eemd_all_nsr_deg = rad2deg(t12_eemd_all_nsr);
t23_eemd_all_nsr_deg = rad2deg(t23_eemd_all_nsr);
t12_emd_all_vf_deg = rad2deg(t12_emd_all_vf);
t23_emd_all_vf_deg = rad2deg(t23_emd_all_vf);
t12_eemd_all_vf_deg = rad2deg(t12_eemd_all_vf);
t23_eemd_all_vf_deg = rad2deg(t23_eemd_all_vf);