...
% ranges
fprintf("theta12 EMD NSR range: %0.2f - %0.2f\n", min(t12_emd_all_nsr_deg), max(t12_emd_all_nsr_deg));
fprintf("theta12 EMD VF range: %0.2f - %0.2f\n", min(t12_emd_all_vf_deg), max(t12_emd_all_vf_deg));
fprintf("theta23 EMD NSR range: %0.2f - %0.2f\n", min(t23_emd_all_nsr_deg), max(t23_emd_all_nsr_deg));
fprintf("theta23 EMD VF range: %0.2f - %0.2f\n", min(t23_emd_all_vf_deg), max(t23_emd_all_vf_deg));
fprintf("theta12 EEMD NSR range: %0.2f - %0.2f\n", min(t12_eemd_all_nsr_deg), max(t12_eemd_all_nsr_deg));
fprintf("theta12 EEMD VF range: %0.2f - %0.2f\n", min(t12_eemd_all_vf_deg), max(t12_eemd_all_vf_deg));
fprintf("theta23 EEMD NSR range: %0.2f - %0.2f\n", min(t23_eemd_all_nsr_deg), max(t23_eemd_all_nsr_deg));
fprintf("theta23 EEMD VF range: %0.2f - %0.2f\n", min(t23_eemd_all_vf_deg), max(t23_eemd_all_vf_deg));

% classifiers emd
evaluate_classifiers(t12_eemd_all_nsr_deg, t23_eemd_all_nsr_deg, ...
                     t12_eemd_all_vf_deg,  t23_eemd_all_vf_deg);
